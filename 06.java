...
//inteiros e imprima como resultado a soma de todos os pares.
...
public class Numeros {
	...
	public void calcularPares(){
		for(int i=0;i<10; i++){	
			//utilização de loop para verificar se cada numero no array eh par
			if(numeros[i]%2==0){
				//caso seja par, sera adicionado em soma
				soma+=numeros[i];										
			}																										
		}			
	}
